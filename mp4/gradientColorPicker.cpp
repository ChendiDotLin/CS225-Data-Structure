...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	int redFill = scolor.red - floor(d*scolor.red/r) + floor(d*ecolor.red/r);
	int greenFill = scolor.green - floor(d*scolor.green/r) + floor(d*ecolor.green/r);
	int blueFill = scolor.blue - floor(d*scolor.blue/r) + floor(d*ecolor.blue/r);
	color.red = redFill;
	color.blue = blueFill;
